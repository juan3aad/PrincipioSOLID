...
public class Ejercicio5_FuncionesMal {
    ...
    // Función para actualizar un usuario si no está vacío
    public void updateUserIfNoEmpty(String username, String newName) {
        if (users.containsKey(username)) {
    ...
    // Función para enviar un correo electrónico si los campos son válidos
    public void sendEmailIfFieldsValid(String username, String email, String message) {
        if (users.containsKey(username)) {
            User user = users.get(username);
